  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        showup: 'appear 1.8s ease-out 500ms forwards, grow 800ms ease-out 500ms forwards',
        'showup-1s': 'appear 1.8s ease-out 1s forwards',
        'appear-up': 'appear 1s linear 1s forwards, slide-up 1s cubic-bezier(.24, .77, .48, .94) 1s forwards',
